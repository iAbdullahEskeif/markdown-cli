...
switch (command) {
    ...
    case "view":
        ...
        (0, notes_1.viewNote)(noteToView);
        break;
    case "edit":
        const editTitle = args[1];
        const editorFlagIndex = args.indexOf("--editor");
        const specifiedEditor = editorFlagIndex !== -1 ? args[editorFlagIndex + 1] : undefined;
        if (!editTitle) {
        ...
        (0, notes_1.editNote)(editTitle, specifiedEditor);
        break;
    case "delete":
        ...
        (0, notes_1.deleteNote)(deletedTitle);
        break;
    default:
